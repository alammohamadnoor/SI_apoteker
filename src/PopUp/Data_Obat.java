...
public class Data_Obat extends javax.swing.JFrame {
    ...
    public form_pemesananObat formPesanObat=null;
    /**
    ...
    private void initComponents() {
        ...
        tbpilihObat = new javax.swing.JTable();
        ...
        tbpilihObat.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbpilihObat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbpilihObatMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbpilihObat);
    ...
    private void tbpilihObatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbpilihObatMouseClicked
        int bar = tbpilihObat.getSelectedRow();
        formPesanObat.a1 = tabmode.getValueAt(bar,0).toString();
        formPesanObat.a2 = tabmode.getValueAt (bar, 1).toString();
        formPesanObat.a3 = tabmode.getValueAt (bar, 4).toString();
        //pnjm1.a5 = tabmode.getValueAt (bar, 4).toString();

        formPesanObat.pilihObat();
        this.dispose();        // TODO add your handling code here:
    }//GEN-LAST:event_tbpilihObatMouseClicked
    ...
    private javax.swing.JTable tbpilihObat;
